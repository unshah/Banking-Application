...
<CENTER><INPUT TYPE="SUBMIT" NAME='submitBNTN' VALUE='Make Deposit'></CENTER><BR>
</FORM>
...
<SCRIPT LANGUAGE="JavaScript">
	       function checkInputs()
	       {
	          ...
	          var Prompts = "";
	           Balance = window.document.DepositPage.AmountField.value;
	           AccountNumber = window.document.DepositPage.AccountNumField.value;
